const stations = { 
    "stations": {
        ...
        "EastFinchley": {
            ...
            "text": "East Finchley",
            "position": {
                "lat": 51.5872974705487,
                "lon": -0.16495632312818
            },
            "zone": 3
        },
        "EastHam": {
        ...
        "Heathrow Terminals": {
            "title": "Heathrow Terminals 123",
            "text": "Heathrow Terminals 123",
            "position": {
                "lat": 51.4712899,
                "lon": -0.4527438
            },
        ...
        "HighBarnet": {
            ...
            "text": "High Barnet",
            "position": {
                "lat": 51.6506519031751,
                "lon": -0.194138165994553
            },
            "zone": 5
        },
        ...
        "ShepardsBushMarket": {
            "title": "Shepard's Bush Market",
            "text": "Shepard's Bush Market",
            "position": {
                "lat": 51.506063,
                "lon": -0.226231
            },
        ...
        "WoodsidePark": {
            ...
            "text": "Woodside Park",
            "position": {
                "lat": 51.6181717295887,
                "lon": -0.185578887883903
            },
            "zone": 4
        }
    },
    "lines": [
        ...
        {
            "name": "Northern",
            "label": "Northern(viaMillHillEast)",
            "color": "#000000",
            "shiftCoords": [
                0,
                0
        ...
        {
            "name": "Metropolitan",
            "label": "Metropolitan(viaUxbridge)",
            "color": "#9B0056",
            "shiftCoords": [
                0,
                0
        ...
        {
            "name": "Metropolitan",
            "label": "Metropolitan(viaAmersham)",
            "color": "#9B0056",
            "shiftCoords": [
                0,
                0
...
export const size = Object.keys(stations["stations"]).length

let stationNames = []
let stationCoords = {}

export function buildMap(map) {
    let lines = stations["lines"]

    for (let line of lines) {
        let lineStations = line["nodes"]
        ...
        for (let station of lineStations) {
            if ("name" in station) {
                ...
                if (stationNames.indexOf(stationName) == -1) stationNames.push(stationName)

                if (prevStation) {
                    map.addStation(prevStation, stationName, lineName)
                    map.addStation(stationName, prevStation, lineName)
                }
    ...
    for (let line of lines) {
        ...
        for (let station of lineStations) {
            if ("name" in station) {
                ...
                stationCoords[stationName] = coords

                prevCoords = coords
            }
        }

        locations[lineLabel] = stationLocations
    }

    return locations
}

export function getStationCoord(station) {
    return stationCoords[station]
}

export function getLineColor(line) {
    for (let l of stations["lines"]) {
        if (l["name"] == line) return l["color"]
    }
}